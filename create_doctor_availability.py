#!/usr/bin/env python3
"""
Script to create doctor availability slots for testing
"""
...
def create_sample_availability():
    """Create sample doctor availability slots"""
    ...
    with app.app_context():
        ...
        print(f"Creating availability for Dr. {doctor.name} (User ID: {doctor_user.id}, Doctor ID: {doctor.id})")
